//Passport authentication, uncomment strategies you want to use
...
passport.use(new GitHubStrategy({
  ...
  callbackURL: 'https://fcc-nightlife-coordination-app-willitt.c9users.io/auth/github/callback',
  passReqToCallback: true
}, (req, accessToken, refreshToken, profile, done) => {
  if (req.user) {
...
exports.isAuthenticated = (req, res, next) => {
  if (req.isAuthenticated() || process.env.ENVIRONMENT === "DEV") {
    return next();
  }
  res.status(403);
  res.json({
...
exports.isAuthorized = (req, res, next) => {
  ...
  if (token || process.env.ENVIRONMENT === "DEV") {
    next();
  } else {
    res.status(401);
    res.json({
